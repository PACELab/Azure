...
class TestRoundRobin(unittest.TestCase):
    ...
    def test_allocation(self):
        ...
        delta_path = os.path.join(home_path,"scheduler/test/test_case_data/tightly_packed_2/allocation_test/delta_config.json")
    ...
    def test_allocation2(self):
        home_path = get_parent_path()
        delta_path = os.path.join(home_path,"scheduler/test/test_case_data/tightly_packed_2/allocation_test2/delta_config.json")
        self.update_config(delta_path)
        self.exe.execute()
        actual_output_path = config["actual_output_path"]
        actual_output_path = os.path.join(get_parent_path(),actual_output_path)
    ...
    def test_no_servers(self):
        home_path = get_parent_path()
        delta_path = os.path.join(home_path,"scheduler/test/test_case_data/tightly_packed_2/no_ofservers_test/delta_config.json")
        self.update_config(delta_path)
        self.exe.execute()
        actual_output_path = config["actual_output_path"]
        actual_output_path = os.path.join(get_parent_path(),actual_output_path)
    ...
    def test_create_delete(self):
        home_path = get_parent_path()
        delta_path = os.path.join(home_path,"scheduler/test/test_case_data/tightly_packed_2/create_delete_test/delta_config.json")
        self.update_config(delta_path)
        self.exe.execute()
        actual_output_path = config["actual_output_path"]
        actual_output_path = os.path.join(get_parent_path(),actual_output_path)
