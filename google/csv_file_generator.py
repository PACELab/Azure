...
def get_only_useful_rows():
    """
    This function tries to read the task_events files(all 500 files) line and line and picks the lines needed and writes them into a single file which would be used by feeder.py to feed in the create,delete and modify requests. 
    """
