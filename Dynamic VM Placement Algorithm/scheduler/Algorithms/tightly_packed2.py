...
class Algorithm(object):
    ...
    def execute(self, tup):
        ...
        if c_d.strip() == "c":
            ...
            if not data:
                ...
                return
            pool_type, server_num,vm_object = data[0], data[1], data[2]
            ...
            print c_d.strip(),"************Failed Operation*******************"
    ...
    def consolidation(self,time_stamp):
        ...
        print "NUMBER OF PERIODIC VMs: ",self.periodicVms
        self.migration(time_stamp)
    ...
    def migration(self,time_stamp):
          ...
          print "Total Number of Servers Used before consolidation: ",self.servers_used
          ...
          for pred,vm in prediction_list:
              pool,server,vm_object = self.vm_server_mapper[vm]
              num_cores = vm_object.cores
              ram_needed = vm_object.ram
              vm_id = vm
              del_tup = (vm_id, time_stamp, num_cores, ram_needed, "d")
          ...
          print "Total Number of Servers Used at this point after consolidation: ",self.servers_used
